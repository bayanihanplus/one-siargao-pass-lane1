...
const trailStops = [
  {
    ...
    body: "Port-backed operational anchor. Booking, voucher, operator readiness, and boarding truth stay attached here.",
    tone: "mist",
  },
  {
    number: "2",
    ...
    title: "Naked Island",
    body: "Classic sandbar stop inside the approved General Luna island-hopping route.",
    tone: "gold",
  },
  {
    number: "3",
    ...
    title: "Daku Island",
    body: "Main island stop for boodle fight lunch, cottage time, and operator-handled inclusions.",
    tone: "mist",
  },
  {
    number: "4",
    ...
    title: "Guyam Island",
    body: "Compact island stop before return handling and trip progress record.",
    tone: "mist",
  },
];

const reasons = [
  ["1", "Classic island route", "Guyam, Naked, Daku, plus Secret Island when tide allows."],
  ["2", "Easy tour day", "Typical 9 AM–4 PM island schedule."],
  ["3", "Pickup support", "Poblacion / General Luna pickup boundary shown clearly."],
  ["4", "Commercial package ready", "Joiner and private boat setup can be selected clearly."],
];
      ...
      <div style={{ maxWidth: 390, margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{ margin: "10px 0 0", color: "rgba(255,255,255,0.82)", fontSize: 12.8, lineHeight: 1.35, fontWeight: 760 }}>
            Choose your date, pax, pickup, and route setup to secure your island-hopping slot.
          </p>
          <Link
            href={bookingHref}
            style={{
