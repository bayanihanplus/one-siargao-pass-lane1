...
const trail = {
  ...
  subtitle: "Falls • inland routes • nature stops",
  icon: "🌿",
  status: "Preview",
  tone: "#16a34a",
  summary: "Move beyond the coast and follow inland stops, falls, and nature routes once verified operations are live.",
  stops: [
    { name: "Taktak Falls", note: "Nature stop", status: "Preview" },
    { name: "Inland Viewpoint", note: "Route node", status: "Coming" },
    { name: "Forest / River Stop", note: "Nature route", status: "Coming" },
  ],
};
