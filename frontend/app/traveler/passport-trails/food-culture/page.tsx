...
const trail = {
  ...
  subtitle: "Local flavors • markets • community stops",
  icon: "🍽️",
  status: "Preview",
  tone: "#f59e0b",
  summary: "Discover food, community, and cultural stops as verified partners and local routes are activated.",
  stops: [
    { name: "Local Food Stop", note: "Partner-ready later", status: "Preview" },
    { name: "Market Stop", note: "Culture node", status: "Coming" },
    { name: "Community Experience", note: "Hosted route", status: "Coming" },
  ],
};
