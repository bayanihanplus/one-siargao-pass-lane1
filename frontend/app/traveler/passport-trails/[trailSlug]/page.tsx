      ...
      >
        <div style={{ padding: "16px 14px 18px" }}>
          <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 14 }}>
            <div>
              <p style={{ margin: 0, fontSize: 10, fontWeight: 640, letterSpacing: "0.13em", textTransform: "uppercase", color: "#13a8b7" }}>
                Passport Trails™
              </p>
              <h1
                style={{
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: 12, lineHeight: 1.42, fontWeight: 600, color: "rgba(255,255,255,0.88)" }}>
                ...
                >
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "flex-start" }}>
                    <div style={{ minWidth: 0 }}>
                      ...
                      <h3 style={{ margin: "4px 0 0", fontSize: 16, lineHeight: 1.1, fontWeight: 640, color: "#14264b" }}>
                        {node.nodeName}
                      </h3>
                    </div>
                  ...
                  <p style={{ margin: "8px 0 0", fontSize: 12, lineHeight: 1.35, color: "#607089", fontWeight: 590 }}>
...
function MiniDetail(props: { label: string; value: string }) {
  return (
    <div style={{ borderRadius: 14, background: "rgba(20,38,75,0.05)", padding: "8px 8px" }}>
      <div style={{ fontSize: 8, fontWeight: 590, color: "#718096", textTransform: "uppercase", letterSpacing: "0.08em" }}>
        {props.label}
      </div>
      <div style={{ marginTop: 3, fontSize: 10, fontWeight: 640, color: "#14264b" }}>{props.value}</div>
    </div>
  );
}
