...
const trail = {
  ...
  subtitle: "Cloud 9 • Pacifico • Coastal viewpoints",
  icon: "🌊",
  status: "Preview",
  tone: "#13a8b7",
  summary: "Follow Siargao’s surf culture and coastal route through verified beach, surf, and viewpoint stops.",
  stops: [
    { name: "Cloud 9", note: "Surf landmark", status: "Preview" },
    { name: "Pacifico", note: "North coast surf", status: "Preview" },
    { name: "Coastal Viewpoints", note: "Scenic stop", status: "Coming" },
  ],
};
