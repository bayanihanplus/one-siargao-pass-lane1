...
const trail = {
  ...
  subtitle: "Local life • heritage • community route",
  icon: "🏘️",
  status: "Preview",
  tone: "#6366f1",
  summary: "Connect travelers to community routes and heritage experiences without exposing unverified operations early.",
  stops: [
    { name: "Town Heritage Stop", note: "Local node", status: "Preview" },
    { name: "Community Route", note: "Governed later", status: "Coming" },
    { name: "Local Life Stop", note: "Cultural node", status: "Coming" },
  ],
};
