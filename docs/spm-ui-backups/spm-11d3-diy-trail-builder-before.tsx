      ...
      <div style={{ maxWidth: 460, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ marginTop: 26 }}>
              ...
              >
                Choose a route style, preview stop candidates, and ask Kuya Tala™ to help shape the request.
                Operator fulfillment, guide support, pricing, payment, and stamp validation remain record-based.
              </p>
            </div>

            <div style={{ marginTop: 18, display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 9 }}>
              <ButtonLink href="#route-options" icon="🧭" variant="primary">
                Pick route style
              </ButtonLink>
        ...
        >
          ...
          >
            ...
            <ButtonLink href="/traveler/settings?panel=assistant&topic=trail" icon="✨" variant="primary">
              Ask Kuya Tala
            </ButtonLink>
          </div>
        </section>
