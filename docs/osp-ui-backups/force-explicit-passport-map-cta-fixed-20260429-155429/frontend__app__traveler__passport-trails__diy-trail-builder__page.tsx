  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" style={{ height: 118 }} />
            <PassportMapShortcut compact title="Open Passport Map while planning" body="Use the map to understand trail locations before finalizing your DIY route draft." />
