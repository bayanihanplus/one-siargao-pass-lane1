 ...
 * Public UI must be traveler-owned: do not expose Staff / Operator / LGU lanes here.
...
function getModeCopy(mode: EntryMode) {
  if (mode === "staff") {
    return {
      ...
      title: "Continue to One Siargao Pass",
      body:
        "Use your assigned account to continue. Traveler pass creation and trip access remain tied to verified account records.",
      formTitle: "Secure sign in",
      formNote: "Use your assigned One Siargao Pass account.",
      next: "/",
    };
  }
    ...
    >
      <div style={{ display: "flex", gap: 11, alignItems: "flex-start" }}>
        ...
        <span style={{ minWidth: 0 }}>
          <span style={{ display: "block", fontSize: 14.2, lineHeight: 1.12, fontWeight: 950 }}>
            {props.title}
          </span>
          <span
            style={{
      ...
      <div style={{ maxWidth: 460, margin: "0 auto" }}>
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ marginTop: 22 }}>
              ...
              <p style={{ margin: "10px 0 0", color: "#fef9c3", fontSize: 15.8, lineHeight: 1.22, fontWeight: 950 }}>
                Your Siargao journey starts with one pass.
              </p>
        ...
        >
          ...
          <h2 style={{ margin: "5px 0 0", fontSize: 20, lineHeight: 1.1, fontWeight: 950 }}>
            Start simple. Continue when ready.
          </h2>
          ...
          <div style={{ marginTop: 12, display: "grid", gap: 8 }}>
            {[
              ...
              ["4", "Your OSP Pass / QR appears when your record is ready"],
            ].map(([number, label]) => (
              <div
                key={label}
                style={{
